namespace HyperMsg.Xmpp
{
    ...
    public static class Roster
    {
        ...
        /// 'iq' stanza for roster request.
        /// </returns>
        public static XmlElement Get(string from)
        {
            return Get().From(from);
        }
        ...
        /// </returns>
        public static XmlElement Set(Jid jid, string name, params string[] groups)
        {
            return Iq.Set().Children(
                Query().Children(
                    Item(jid, name, groups)));
        }
        ...
        /// </returns>
        public static XmlElement Remove(Jid jid)
        {
            return Iq.Set().Children(
                Query().Children(
                    Item(jid).Attribute("subscription", "remove")));
        }

        private static XmlElement Query()
        {
            return new XmlElement("query").Xmlns(RosterXmlns);
        }
